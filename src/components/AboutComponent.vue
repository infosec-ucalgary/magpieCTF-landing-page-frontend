<template>
  <section id="about">
    <div class="mx-auto w-2/3">
      <p class="text-5xl text-center mt-5 mb-3 neon-red">About</p>
      <div>
        <div class="mb-5">
        ...
        <div class="mb-5">
          ...
          <p class="text-xl text-white">magpieCTF is a two day event <strong>starting February 19th at 4pm MST and ending February 21st at 4pm MST.</strong></p>
        </div>
        <div class="mb-5">

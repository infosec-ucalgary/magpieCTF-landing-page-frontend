<template>
  <div class="h-full bg-cover neon-grey-2" :style="{ backgroundImage: `url(${bgImage})` }" id="outer-container">
    ...
    <div class="w-10/12 mx-auto">
      <div class="grid gap-4 md:grid-cols-5 grid-cols-1">
        ...
        <div class="relative col-span-3 text-white text-center">
          <p class="p-8 text-sm 2xl:text-md rounded-lg bg-black m-4 2xl:m-12"> The
            ...
            from difficulty understanding and completing tasks to outright violence and aggression. <br><br>These days, most of the business in the
    ...
    <section>
      <p class="font-semibold text-center text-xl sm:text-6xl pt-4 my-10">
        <a href="https://2024.magpiectf.ca/" class="neon-grey-2 bg-black p-8 pt-4 rounded-lg underline" target="_blank">Register for MagpAI CTF 2024</a>
      </p>
    </section>
    <AboutComponent />
    <FooterComponent />
